...
/* STEP 4: Add a more complicated function to the object that describes the person, their age, gender, 
    ...
    person.bio = function () {
        alert (`The interests of ${this.name.firstName} ${this.name.lastName} of age ${this.age} of gender ${this.gender} are ${this.interests}.`);
    };
...
person1.hello(); // This will alert "Hello! I am Person1"
person2.hello(); // This will alert "Hello! I am Person2"
